...
make -> Compila el programa principal, el main debe encontrarse en la carpeta src. El ejecutable irá a la carpeta bin
make TEST=prueba test -> Compila el programa prueba.cpp de la carpeta test
